...
const routes = [
  ...
  { path: '/:courseType/:courseName/groupe', name: 'SelectGroupCall', component: SelectGroupForCall },
  { path: '/:courseType/:courseName/:groupId/:groupName/appel', name: 'Call', component: CallPage },
  ...
  { path: '/recapitulatifs/matiere/:courseName', name: 'CourseSummary', component: CourseSummaryPage },
